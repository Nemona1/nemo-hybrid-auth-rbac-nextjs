...
import { 
  Globe, Smartphone, Laptop, Clock, XCircle, Shield, 
    ...
    <Card className="p-6">
      ...
      <div className="bg-primary/5 border border-primary/20 rounded-lg p-3 mb-4">
        <div className="flex items-start gap-2">
          ...
          <p className="text-xs text-muted">
            Regularly review your active sessions. If you see any device you don't recognize, revoke it immediately.
          </p>
        </div>
      </div>
      ...
      {sessions.length === 0 ? (
        <div className="text-center py-8">
          <Smartphone className="h-12 w-12 text-muted mx-auto mb-3" />
        ...
        <div className="space-y-3">
          {sessions.map((session) => {
            ...
            return (
              <div key={session.sessionToken} className={`p-4 rounded-lg transition-all duration-200 ${isCurrent ? 'border border-primary/30 bg-primary/5' : 'bg-muted/5'}`}>
